...
class ReturnActionTypeServiceImplTest {
    private ActionTypeService returnActionTypeService;

    @BeforeEach
    void setUp() {
        returnActionTypeService = new SupplyActionTypeServiceImpl();
    }

    @Test
    void applyTheQuantity_nullStorage_notOk() {
        assertThrows(NullPointerException.class,
                () -> returnActionTypeService.applyTheQuantity(null, "banana", 10));
    }
    ...
    void applyTheQuantity_nullProductName_Ok() {
        ...
        returnActionTypeService.applyTheQuantity(current, null, 10);
    ...
    void applyTheQuantity_negativeQuantity_notOk() {
        ...
        assertThrows(InvalidDataException.class,
                () -> returnActionTypeService.applyTheQuantity(storage, "banana", -10));
    }
    ...
    void applyTheQuantity_overflowQuantity_notOk() {
        ...
        assertThrows(ArithmeticException.class,
                () -> returnActionTypeService.applyTheQuantity(
                        storage,
                        "banana",
                        5));
    }
    ...
    void applyTheQuantity_allCorrect_Ok() {
        Storage current = new Storage();
        returnActionTypeService.applyTheQuantity(current, "banana", 10);
        returnActionTypeService.applyTheQuantity(current, "apple", 15);
    ...
    void applyTheQuantity_fewSameProducts_Ok() {
        Storage current = new Storage();
        returnActionTypeService.applyTheQuantity(current, "banana", 10);
        returnActionTypeService.applyTheQuantity(current, "banana", 15);
    ...
    void applyTheQuantity_emptyProductName_Ok() {
        Storage current = new Storage();
        returnActionTypeService.applyTheQuantity(current, "", 10);
    ...
    void applyTheQuantity_productNameInUkrainian_Ok() {
        ...
        returnActionTypeService.applyTheQuantity(current, "банан", 10);
